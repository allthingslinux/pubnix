...
class ValidationService:
    ...
    RESERVED_USERNAMES = {
        "root", "admin", "administrator", "www", "mail", "ftp", "ssh", "http", "https",
        "api", "app", "web", "server", "system", "daemon", "service", "user", "guest",
        "test", "demo", "example", "sample", "temp", "tmp", "bin", "sbin", "usr", "var",
        "etc", "opt", "home", "lib", "dev", "proc", "sys", "boot", "mnt", "media",
        "pubnix", "atl", "linux", "unix", "shell", "bash", "zsh", "fish", "csh",
    }
    ...
    def get_validation_errors(self, username: str, email: str, full_name: str) -> List[str]:
